...
echo "  # The trailing 'tr -d' strips a newline gcloud appends — without it"
echo "  # the newline gets into the Authorization header and curl returns"
echo "  # 'error 43: bad argument' with HTTP 000."
echo "  TOKEN=\$(gcloud auth print-identity-token \\"
echo "      --impersonate-service-account=${CALLER_SA_EMAIL} \\"
echo "      --audiences=${SERVICE_URL} | tr -d '[:space:]')"
